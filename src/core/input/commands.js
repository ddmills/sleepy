...
export default [
    ...
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_NW,              'move_nw',                true, KEY_Q,        false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_N,               'move_n',                 true, KEY_W,        false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_N,               'move_n2',                true, KEY_UP,       false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_NE,              'move_ne',                true, KEY_E,        false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_W,               'move_w',                 true, KEY_A,        false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_W,               'move_w2',                true, KEY_LEFT,     false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_E,               'move_e',                 true, KEY_D,        false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_E,               'move_e2',                true, KEY_RIGHT,    false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_SW,              'move_sw',                true, KEY_Z,        false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_S,               'move_s',                 true, KEY_X,        false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_S,               'move_s2',                true, KEY_DOWN,     false, false, false, false),
    cmd(INPUT_DOMAIN_DEFAULT,   INPUT_CMD_MOVE_SE,              'move_se',                true, KEY_C,        false, false, false, false),
